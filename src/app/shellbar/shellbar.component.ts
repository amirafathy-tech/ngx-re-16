...
import { ShellbarComponent, ShellbarLogoComponent, ShellbarMenuItem, ShellbarSidenavDirective, ShellbarSizes, ShellbarUser, ShellbarUserMenu } from '@fundamental-ngx/core/shellbar';
...
export class ShellbarSidebarComponent {
    condensed = false;
